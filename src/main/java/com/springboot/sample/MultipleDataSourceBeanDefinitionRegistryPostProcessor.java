...
public class MultipleDataSourceBeanDefinitionRegistryPostProcessor
   ...
   //private static final Object DATASOURCE_TYPE_DEFAULT = "com.zaxxer.hikari.HikariDataSource";
	...
	public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
		System.out.println("Invoke Metho postProcessBeanFactory");
	...
	/**
	 * 读取application.properties文件，加载多数据源配置到Map中
	 */
	@Override
	...
	public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
		 System.out.println("Invoke Metho postProcessBeanDefinitionRegistry");
